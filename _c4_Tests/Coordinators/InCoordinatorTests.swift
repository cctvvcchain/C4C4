...
class InCoordinatorTests: XCTestCase {
    ...
    func testChangeRecentlyUsedAccount() {
        let account1: _c4_.Wallet = .make(type: .address(Address(string: "0x1000000000000000000000000000000000000000")!))
        let account2: _c4_.Wallet = .make(type: .address(Address(string: "0x2000000000000000000000000000000000000000")!))
