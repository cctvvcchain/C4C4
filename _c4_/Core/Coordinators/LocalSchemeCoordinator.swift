...
class LocalSchemeCoordinator: Coordinator {
    ...
    lazy var _c4_WalletSDK: _c4_WalletSDK = {
        return _c4_WalletSDK(delegate: self)
    }()
...
extension LocalSchemeCoordinator: WalletDelegate {
    ...
    func signTransaction(_ transaction: _c4_Core.Transaction, completion: @escaping (Data?) -> Void) {
