...
enum RPCServer {
    ...
    var remoteURL: URL {
        let urlString: String = {
            switch self {
            case .main: return "https://api._c4_walletapp.com"
            case .classic: return "https://classic._c4_walletapp.com"
            case .callisto: return "https://callisto._c4_walletapp.com"
            case .kovan: return "https://kovan._c4_walletapp.com"
            case .ropsten: return "https://ropsten._c4_walletapp.com"
            case .rinkeby: return "https://rinkeby._c4_walletapp.com"
            case .poa: return "https://poa._c4_walletapp.com"
            case .sokol: return "https://_c4_-sokol.herokuapp.com"
            case .custom:
