...
class SupportViewController: FormViewController {
    ...
    override func viewDidLoad() {
        ...
        form +++ Section()
            ...
            <<< link(
                ...
                value: "https://_c4_walletapp.com/terms.html",
    ...
    func sendUsEmail() {
        ...
        composerController.setSubject(NSLocalizedString("settings.feedback.email.title", value: "_c4_ Feedback", comment: ""))
    ...
    private func emailTemplate() -> String {
        ...
        _c4_ Version: \(Bundle.main.fullVersion)
