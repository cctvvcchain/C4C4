...
extension WKWebViewConfiguration {
    ...
    static func make(for account: Wallet, with sessionConfig: Config, in messageHandler: WKScriptMessageHandler) -> WKWebViewConfiguration {
        ...
        guard
            let bundlePath = Bundle.main.path(forResource: "_c4_Web3Provider", ofType: "bundle"),
            let bundle = Bundle(path: bundlePath) else { return config }

        if let filepath = bundle.path(forResource: "_c4_-min", ofType: "js") {
            do {
        ...
        function executeCallback (id, error, value) {
          _c4_.executeCallback(id, error, value)
        }
        ...
        web3.setProvider = function () {
          console.debug('_c4_ Wallet - overrode web3.setProvider')
        }
